...
If you find a security vulnerability in Audio XAI Fragility, please report it through [GitHub's private vulnerability reporting](https://github.com/cncPomper/Audio-XAI-Fragility/security/advisories/new). This keeps the details private while we work on a fix.
...
**Enterprise support** is available, with priority response SLAs. Contact piotr.kitlowski@gmail.com for details.
